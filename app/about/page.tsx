        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-white/80 mb-8">
              We are dedicated to providing the highest quality essential oils
              and natural products, crafted with precision and care for your
              wellbeing.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <img
                src="/essential-oil-production-facility-with-botanical-p.jpg"
                alt="Our facility"
            ...
            <div>
              ...
              <h2 className="text-3xl lg:text-5xl font-bold text-[#1a3a2e] mb-6">
                Crafting excellence since 2010
              </h2>
              <p className="text-gray-700 mb-6 leading-relaxed">
                Our journey began with a simple mission: to bring the purest,
                most effective essential oils to people seeking natural wellness
                solutions. Over the years, we've perfected our extraction and
                bottling processes to ensure every drop meets our exacting
                standards.
              </p>
              <p className="text-gray-700 mb-8 leading-relaxed">
                Today, we're proud to serve thousands of customers worldwide,
                helping them discover the transformative power of nature's
                finest ingredients.
              </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1a3a2e] mb-4">
                100% Natural
              </h3>
              <p className="text-gray-700 leading-relaxed">
                We source only the finest organic ingredients, ensuring purity
                in every bottle.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-700 leading-relaxed">
                Every drop is carefully extracted and bottled with meticulous
                attention to detail.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-700 leading-relaxed">
                Rigorous testing and quality control ensure you receive only the
                best products.
              </p>
            </div>
          </div>
