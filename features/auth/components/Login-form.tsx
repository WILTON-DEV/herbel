...
export function LoginForm() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Call Better Auth social sign-in endpoint
      ...
      // Redirect to OAuth provider if URL is returned
      ...
      <Card className="w-full">
        <CardContent className="p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button
              type="submit"
              className="h-12 w-full rounded-lg text-base font-medium shadow-md transition-all duration-200"
              disabled={isLoading}
            >
            ...
            <Button
              ...
              className="border-foreground hover:bg-background text-muted-foreground h-12 w-full rounded-lg bg-transparent text-base font-medium transition-colors"
            >
