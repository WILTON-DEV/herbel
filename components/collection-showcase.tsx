      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <Link href="/shop?collection=signature" className="group">
            <div className="relative h-[500px] rounded-3xl overflow-hidden bg-[#1a3a2e]">
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                ...
                <p className="text-gray-300 mb-4">Premium essential oils for discerning customers</p>
                <Button className="bg-white text-[#1a3a2e] hover:bg-gray-100">
                  Explore Collection
          ...
          <div className="space-y-8">
            <Link href="/shop?collection=wellness" className="group block">
              <div className="relative h-[240px] rounded-3xl overflow-hidden bg-white">
                <Image
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-center text-white">
                  ...
                  <p className="text-gray-300 text-sm mb-4">Holistic health solutions</p>
            ...
            <Link href="/shop?collection=aromatherapy" className="group block">
              <div className="relative h-[240px] rounded-3xl overflow-hidden bg-white">
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-center text-white">
                  ...
                  <p className="text-gray-300 text-sm mb-4">Scents for every mood</p>
                  <div className="flex items-center text-[#c9a961] font-medium">
                    Shop Now <ArrowRightIcon className="ml-2 w-4 h-4" />
                  </div>
                </div>
